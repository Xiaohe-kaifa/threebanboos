    ...
    <main class="el-main" >
        <el-card style="max-width: 100% ;height: 99%; ">
            ...
            <div class="card-header" style="margin-top: -10px; height: 15px;">
              <span><el-breadcrumb  style=" white-space: nowrap; display: flex; ">
                  ...
                  <div class="anniu00" style="margin-left: 70%;">
                    <CommodityAdd ref="updateDateAdd" @actionSearch="actionSearch"  />
          ...
          <el-scrollbar height="550px">
            <div class="business-search" v-if="businessSearch">
              ...
              <el-form :model="formSearch" :inline="true"  class="demo-form-inline" >
                ...
                <el-form-item :label-width="businessWidth" label="商品名称" >
                  <el-input  placeholder="填写商品名称" style="width: 90%; " v-model="formSearch.commodityName"  />
                </el-form-item>
                <el-form-item :label-width="businessWidth" label="商家" >
                  <el-input  placeholder="填写商家" style="width: 90%; " v-model="formSearch.commodityShopName"  />
                </el-form-item>
                
                <el-form-item :label-width="businessWidth" label="产品类型" >
                  <el-select style="width: 100px;" v-model="formSearch.commodityType" placeholder="商家类型">
            ...
            <CommodityTable @onUpdated="onUpdated" style="position: relative;"  ref="updateDate"/>
        </el-scrollbar> 
        </el-card>
    </main>
</template>
...
const onUpdated=(table:any)=>{
  updateDateAdd.value.onUpdatedAdd(table)
}
