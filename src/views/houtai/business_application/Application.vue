          ...
          <template #header >
            <div class="card-header" style="margin-top: -10px; height: 15px;">
              <span><el-breadcrumb  style=" white-space: nowrap; display: flex; ">
                  ...
                  <el-breadcrumb-item>商家申请表</el-breadcrumb-item>
                  <div class="anniu00" style="margin-left: auto;">
                    <ApplicationSubmit @actionSearch="actionSearch" />
          ...
          <el-scrollbar height="550px">
            <div class="business-search" v-if="businessSearch">
              ...
              <el-form :model="formSearch" :inline="true"  class="demo-form-inline" >
                <el-form-item :label-width="businessWidth" label="申请时间" >
                  <el-date-picker
                    v-model="formSearch.business_submit_time"
                    type="date"
                    placeholder="选择申请日期"
                    format="YYYY/MM/DD"
                ...
                <el-form-item :label-width="businessWidth" label="申请账号" >
                  <el-input  placeholder="填写账号" style="width: 90%; " v-model="formSearch.business_id"  />
                </el-form-item>
                <el-form-item :label-width="businessWidth" label="商家店铺名称" >
                  <el-input  placeholder="填写店铺名称" style="width: 90%; " v-model="formSearch.business_name"  />
                </el-form-item>
                <el-form-item :label-width="businessWidth" label="申请人姓名" >
                  <el-input  placeholder="姓名" style="width: 90%; " v-model="formSearch.business_true_name"  />
                </el-form-item>
                <el-form-item :label-width="businessWidth" label="商家类型" >
                  <el-select style="width: 100px;" v-model="formSearch.business_type" placeholder="商家类型">
                    <el-option label="竹编家具" value="0" />
                    <el-option label="工艺品" value="1"/>
                  </el-select>
                </el-form-item>
                
                <el-form-item :label-width="businessWidth" label="申请人手机号" >
                  <el-input  placeholder="填写手机号" style="width: 90%; " v-model="formSearch.business_phone"  />
                </el-form-item>
                <el-form-item :label-width="businessWidth" label="身份证号码" >
                  <el-input  placeholder="身份证号码" style="width: 90%; " v-model="formSearch.business_identification_number"  />
                </el-form-item>
                <el-form-item :label-width="businessWidth" label="申请地址" >
                  <el-cascader
                :options="regionData"
                placeholder="选择地址"
                style="width: 300px;"
                v-model="formSearch.business_address">
                </el-cascader>
                </el-form-item>
            ...
            <ApplicationTable ref="updateDate"/>
        </el-scrollbar>
        </el-card>
    </main>
</template>
